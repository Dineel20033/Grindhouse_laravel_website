...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <livewire:video-player src="{{ asset('assets/videos/gym_video.mp4') }}" class="fixed inset-0 w-full h-full object-cover -z-20" autoplay muted loop playsinline />
        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 relative">
            ...
            <!-- Main Card -->
            <div class="w-full sm:max-w-md mx-4 relative z-10">
                <div class="glass-card px-8 py-6 shadow-2xl rounded-2xl">
                    {{ $slot }}
                </div>
