...
@section('content')
<div class="bg-white dark:bg-zinc-900 lg:dark:bg-white">
    <!-- Hero Section -->
    ...
    <!-- Our Mission Section -->
    <section class="py-16 md:py-24 bg-white dark:bg-zinc-900 lg:dark:bg-white">
        <div class="max-w-7xl mx-auto px-6 md:px-12">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                <div class="order-2 lg:order-1">
                    <div class="inline-block px-4 py-2 bg-amber-100 dark:bg-amber-900/50 lg:dark:bg-amber-100 rounded-full text-amber-800 dark:text-amber-500 lg:dark:text-amber-800 text-sm font-semibold mb-6">
                        Our Mission
                    </div>
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white lg:dark:text-gray-900 mb-6">
                        Empowering Every Fitness Journey
                    </h2>
                    <p class="text-gray-700 dark:text-gray-300 lg:dark:text-gray-700 leading-relaxed mb-6">
                    ...
                    <p class="text-gray-700 dark:text-gray-300 lg:dark:text-gray-700 leading-relaxed">
    ...
    <section class="py-16 md:py-24 bg-gray-50 dark:bg-zinc-800 lg:dark:bg-gray-50">
        <div class="max-w-7xl mx-auto px-6 md:px-12">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div class="order-2 lg:order-2">
                    ...
                    <div class="text-gray-700 dark:text-gray-300 lg:dark:text-gray-700 leading-relaxed space-y-6">
                        <p>
    ...
    <section class="py-16 md:py-24 bg-white dark:bg-zinc-900 lg:dark:bg-white">
        <div class="max-w-7xl mx-auto px-6 md:px-12">
            <div class="text-center mb-16">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white lg:dark:text-gray-900 mb-4">
                    What We Stand For
                </h2>
                <p class="text-gray-700 dark:text-gray-300 lg:dark:text-gray-700 text-lg max-w-2xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Value 1 -->
                <div class="bg-gradient-to-br from-amber-50 to-white dark:from-zinc-800 dark:to-zinc-900 lg:dark:from-amber-50 lg:dark:to-white p-8 rounded-2xl border border-amber-100 dark:border-zinc-700 lg:dark:border-amber-100 hover:shadow-xl transition-shadow">
                    <div class="w-14 h-14 bg-amber-600 dark:bg-amber-700 lg:dark:bg-amber-600 rounded-xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 lg:dark:text-gray-900 mb-3">Quality First</h3>
                    <p class="text-gray-700 dark:text-gray-400 lg:dark:text-gray-700 leading-relaxed">
                ...
                <div class="bg-gradient-to-br from-amber-50 to-white dark:from-zinc-800 dark:to-zinc-900 lg:dark:from-amber-50 lg:dark:to-white p-8 rounded-2xl border border-amber-100 dark:border-zinc-700 lg:dark:border-amber-100 hover:shadow-xl transition-shadow">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 lg:dark:text-gray-900 mb-3">Customer Focus</h3>
                    <p class="text-gray-700 dark:text-gray-400 lg:dark:text-gray-700 leading-relaxed">
                ...
                <div class="bg-gradient-to-br from-amber-50 to-white dark:from-zinc-800 dark:to-zinc-900 lg:dark:from-amber-50 lg:dark:to-white p-8 rounded-2xl border border-amber-100 dark:border-zinc-700 lg:dark:border-amber-100 hover:shadow-xl transition-shadow">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 lg:dark:text-gray-900 mb-3">Innovation</h3>
                    <p class="text-gray-700 dark:text-gray-400 lg:dark:text-gray-700 leading-relaxed">
                ...
                <div class="bg-gradient-to-br from-amber-50 to-white dark:from-zinc-800 dark:to-zinc-900 lg:dark:from-amber-50 lg:dark:to-white p-8 rounded-2xl border border-amber-100 dark:border-zinc-700 lg:dark:border-amber-100 hover:shadow-xl transition-shadow">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 lg:dark:text-gray-900 mb-3">Fair Value</h3>
                    <p class="text-gray-700 dark:text-gray-400 lg:dark:text-gray-700 leading-relaxed">
                ...
                <div class="bg-gradient-to-br from-amber-50 to-white dark:from-zinc-800 dark:to-zinc-900 lg:dark:from-amber-50 lg:dark:to-white p-8 rounded-2xl border border-amber-100 dark:border-zinc-700 lg:dark:border-amber-100 hover:shadow-xl transition-shadow">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 lg:dark:text-gray-900 mb-3">Education</h3>
                    <p class="text-gray-700 dark:text-gray-400 lg:dark:text-gray-700 leading-relaxed">
                ...
                <div class="bg-gradient-to-br from-amber-50 to-white dark:from-zinc-800 dark:to-zinc-900 lg:dark:from-amber-50 lg:dark:to-white p-8 rounded-2xl border border-amber-100 dark:border-zinc-700 lg:dark:border-amber-100 hover:shadow-xl transition-shadow">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 lg:dark:text-gray-900 mb-3">Integrity</h3>
                    <p class="text-gray-700 dark:text-gray-400 lg:dark:text-gray-700 leading-relaxed">
