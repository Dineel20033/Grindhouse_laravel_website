<x-guest-layout>
    <div class="text-center mb-6 md:mb-8">
        ...
        <p class="text-gray-500 text-sm">Join us to get started with your account</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5" x-data="{ show: false, showConfirm: false }">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="name" class="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-lg bg-gray-50 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-300 input-focus" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Enter your full name" />
            </div>
        </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="password_confirmation" :type="showConfirm ? 'text' : 'password'" class="block w-full pl-10 pr-10 py-3 border border-gray-200 rounded-lg bg-gray-50 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-300 input-focus" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm password" />
                
                {{-- Toggle Password Visibility --}}
                <div class="absolute inset-y-0 right-0 pr-3 flex items-center cursor-pointer text-gray-400 hover:text-gray-600" @click="showConfirm = !showConfirm">
